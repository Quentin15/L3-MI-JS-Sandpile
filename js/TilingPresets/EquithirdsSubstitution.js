...
Tile.prototype.iso2equi = function(){
  this.id[0]='equi';
  let i2 = (this.bounds[2]-this.bounds[0]) / (2 * Math.cos(Math.PI/6)) + this.bounds[0];
  let i3 = (this.bounds[3]-this.bounds[1]) / (2 * Math.cos(Math.PI/6)) + this.bounds[1];
  let i4 = ((this.bounds[2]-this.bounds[0]) * Math.cos(Math.PI/3) - (this.bounds[3]-this.bounds[1]) * Math.sin(Math.PI/3)) / Math.pow(2 * Math.cos(Math.PI/6), 1) + this.bounds[0];
  let i5 = ((this.bounds[3]-this.bounds[1]) * Math.cos(Math.PI/3) + (this.bounds[2]-this.bounds[0]) * Math.sin(Math.PI/3)) / Math.pow(2 * Math.cos(Math.PI/6), 1) + this.bounds[1];
  this.bounds[2] = i2;
  this.bounds[3] = i3;
  this.bounds[4] = i4;
  this.bounds[5] = i5;
...
function substitutionEq(tile){
  switch(tile.id[0]){
    case 'equi':
	  ...
	  newiso1.scale(tile.bounds[0],tile.bounds[1],1/(2*Math.cos(Math.PI/6)));
	  ...
	  newiso2.scale(tile.bounds[0],tile.bounds[1],1/(2*Math.cos(Math.PI/6)));
	  ...
	  newiso3.scale(tile.bounds[0],tile.bounds[1],1/(2*Math.cos(Math.PI/6)));
    ...
    case 'iso':
	  ...
	  newiso4.scale(tile.bounds[0],tile.bounds[1],1/(2*Math.cos(Math.PI/6)));
	  ...
	  newiso5.scale(tile.bounds[0],tile.bounds[1],1/(2*Math.cos(Math.PI/6)));
	  ...
	  newequi1.scale(tile.bounds[0],tile.bounds[1],1/(2*Math.cos(Math.PI/6)));
